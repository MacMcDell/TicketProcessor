...
public interface IEventService
{
    ...
    Task<PagedResult<EventListItemDto>> GetEventsListAsync(PageQuery query, CancellationToken ct = default);
    ...
    Task<EventListItemDto> GetEventDetailsAsync(Guid eventId, CancellationToken ct);
    Task<PagedResult<EventTicketTypeDto>> GetTicketTypesAsync(PageQuery query, CancellationToken ct);
}