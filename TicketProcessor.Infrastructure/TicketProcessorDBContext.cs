    ...
    : DbContext(options)
{
    ...
    private static void SeedInitialData(ModelBuilder b)
    {
        ...
        b.Entity<Venue>().HasData(
            new
            {
                Id = v1, Name = "Commodore Ballroom", Capacity = 900, Created = created, LastModified = created,
                IsDeleted = false
            },
            new
            {
                Id = v2, Name = "Queen Elizabeth Theatre", Capacity = 2765, Created = created, LastModified = created,
                IsDeleted = false
            }
        );
        ...
        b.Entity<Event>().HasData(
            new
            {
                Id = e1, VenueId = v1, Title = "The Alpines", StartsAt = starts1, Description = "Tour kickoff",
                Created = created, LastModified = created, IsDeleted = false
            },
            new
            {
                Id = e2, VenueId = v1, Title = "DJ Night", StartsAt = starts2, Description = (string?)null,
                Created = created, LastModified = created, IsDeleted = false
            },
            new
            {
                Id = e3, VenueId = v2, Title = "Symphonic Rock", StartsAt = starts3, Description = (string?)null,
                Created = created, LastModified = created, IsDeleted = false
            }
        );
        ...
        b.Entity<EventTicketType>().HasData(
            new
            {
                Id = ett1, EventId = e1, Name = "GA", Price = 49.99m, Capacity = 800, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            },
            new
            {
                Id = ett2, EventId = e1, Name = "VIP", Price = 129.00m, Capacity = 100, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            },
            new
            {
                Id = ett3, EventId = e2, Name = "GA", Price = 39.00m, Capacity = 850, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            },
            new
            {
                Id = ett4, EventId = e2, Name = "VIP", Price = 95.00m, Capacity = 50, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            },
            new
            {
                Id = ett5, EventId = e3, Name = "GA", Price = 59.00m, Capacity = 2200, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            },
            new
            {
                Id = ett6, EventId = e3, Name = "VIP", Price = 149.00m, Capacity = 300, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            },
            new
            {
                Id = ett7, EventId = e3, Name = "Balcony", Price = 79.00m, Capacity = 265, Sold = 0, Created = created,
                LastModified = created, IsDeleted = false
            }
        );
